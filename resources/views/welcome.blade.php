...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <img style="width:100%; height:100vh; z-index:-1;" class="img-responsive" src="{{asset('images/blog-home.jpg')}}">

        {{--<div class="centered display-1">Welcome</div>--}}
    </div>
            ...
            <div  class="collapse navbar-collapse " id="myTogglerNav">
                <div class="navbar-nav ml-auto" style="float:right; font-size: large;">
                    ...
                    @if(Auth::user())
                        ...
                        <a  style="color:white;" class="nav-item nav-link ml-auto" href="{{route('admin.index')}}">Dashboard</a>
                            @endif
                        @endif
